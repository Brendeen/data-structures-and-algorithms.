...
const addExclamation = (arr) => {
  const newStringArr = [];
  arr.forEach(function(value){newStringArr.push(value + "!")});
  return newStringArr;
};
...
const allUpperCase = (arr) => {
  const newUpperCaseArr = [];
  arr.forEach(function(value){newUpperCaseArr.push(value.toUpperCase())});
